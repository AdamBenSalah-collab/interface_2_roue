...
void setup_scr_record(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->record, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui->record, &_abs_720x1280, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->record, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->record, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes record_btn_1
    ui->record_btn_1 = lv_btn_create(ui->record);
    ui->record_btn_1_label = lv_label_create(ui->record_btn_1);
    lv_label_set_text(ui->record_btn_1_label, "<");
    ...
    lv_obj_set_pos(ui->record_btn_1, 311, 868);
    lv_obj_set_size(ui->record_btn_1, 116, 72);
    ...
    lv_obj_set_style_text_font(ui->record_btn_1, &lv_font_montserratMedium_46, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_chart_set_div_line_count(ui->record_chart_board, 3, 5);
    ...
    lv_chart_set_next_value(ui->record_chart_board, ui->record_chart_board_0, 1);
    ...
    lv_chart_set_next_value(ui->record_chart_board, ui->record_chart_board_0, 0);
#endif
    lv_obj_set_pos(ui->record_chart_board, 187, 260);
    lv_obj_set_size(ui->record_chart_board, 367, 514);
    ...
    lv_obj_set_style_bg_opa(ui->record_chart_board, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->record_chart_board, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->record_chart_board, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->record_chart_board, lv_color_hex(0xe8e8e8), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->record_chart_board, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->record_chart_board, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_line_width(ui->record_chart_board, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_line_color(ui->record_chart_board, lv_color_hex(0xe8e8e8), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->record_chart_board, &lv_font_montserratMedium_12, LV_PART_TICKS|LV_STATE_DEFAULT);
